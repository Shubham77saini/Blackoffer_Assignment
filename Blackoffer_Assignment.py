...
df = pd.read_excel(r'C:\\Users\\shubh\\.jupyter\\cik_list.xlsx')
df.head()
...
with open(r'C:\Balckoffer_project\StopWords_Generic.txt','r') as f:
    stop_words = f.read()
...
master_dic = pd.read_excel(r'C:\Balckoffer_project\LoughranMcDonald_MasterDictionary_2018.xlsx')
master_dic.head()
...
uncertainity = pd.read_excel(r'C:\Balckoffer_project\uncertainty_dictionary.xlsx')
uncertainity_words = list(uncertainity['Word'])

constraining = pd.read_excel(r'C:\Balckoffer_project\constraining_dictionary.xlsx')
    ...
    for j in caps:
        ...
        if x:
            ...
            if ('...' not in content) and ('. . .' not in content) and len(content) > 200:
                ...
                constraining_word_proportions = constraining_score/num_words
                ...
                df.at[i,section_map[j]+'_constraining_word_proportions'] = constraining_word_proportion
